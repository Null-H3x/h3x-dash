...
MODULE_CLASSES: dict[str, list[str]] = {
    ...
    'exploit/multi/misc/java_rmi_server':                      ['linux_server', 'windows_server', 'web_application'],
    'exploit/unix/irc/unreal_ircd_3281_backdoor':              ['linux_server'],
    'exploit/unix/misc/distcc_exec':                           ['linux_server'],
...
def module_applies(msf_module: str, class_id: str) -> bool:
    ...
    return class_id in MODULE_CLASSES[msf_module]
